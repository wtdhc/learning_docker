package com.github.two.service.impl;

import com.github.two.domain.NameValue;
import com.github.two.mapper.NameValueMapper;
import com.github.two.model.AllNameValueTO;
import com.github.two.model.NameValueTO;
import com.github.two.repository.NameValueRepository;
...
public class NameValueServiceImpl implements NameValueService {
    ...
    public NameValueTO updateNameValue(NameValueTO nameValueTO, boolean fromRabbit) {
        try {
            Optional<NameValue> nameValueOptional = nameValueRepository.findByName(nameValueTO.getName());

            if (nameValueOptional.isPresent()) {
                nameValueOptional.get().setValue(nameValueTO.getValue());
                logger.info("Updated: " + nameValueTO);
            } else {
                nameValueRepository.save(NameValueMapper.INSTANCE.getNameValue(nameValueTO));
            }
